  ...
  export default {
    ...
    methods: {
      ...
      async getBans () {
        ...
        const endpoint = `` + process.env.APISERVER + `v1/chat/bans`;
      ...
      async banUser () {
        const endpoint = `` + process.env.APISERVER + `v1/chat/ban`;
        const payload =  {
          user: this.username,
          ban: this.username,
        }
      ...
      async unbanUser () {
        const endpoint = `` + process.env.APISERVER + `v1/chat/unban`;
        const payload =  {
          user: this.username,
          ban: this.username,
        }
      ...
      async purgeLocal () {
        // Run command
        const endpoint = `` + process.env.APISERVER + `v1/admin/chat/local-purge`;
        const payload =  {
