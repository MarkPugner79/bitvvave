...
<script>
  ...
  const endpoint = '' + process.env.APISERVER + 'v1/admin/stream/kick';
  const transcodeEndpoint = '' + process.env.APISERVER + 'v1/streamer/transcoder/';
  const nsfwEndpoint = '' + process.env.APISERVER + 'v1/admin/stream/';

  export default {
    name: 'AdminStreamControl',
