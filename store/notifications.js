...
export const actions = {
  ...
  async [$actions.saveTokenFCM] ( { state, commit } ) {
    ...
    const endpoint = '' + process.env.APISERVER + 'v1/fcm/set-token';
  ...
  async [$actions.subscribeToUser] ( { state, commit }, channel ) {
    ...
    const endpoint = '' + process.env.APISERVER + 'v1/fcm/subscribe';
  ...
  async [$actions.unsubscribeFrom] ( { state, commit }, channel ) {
    ...
    const endpoint = '' + process.env.APISERVER + 'v1/fcm/unsubscribe';
