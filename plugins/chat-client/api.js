...
var $log = new log_1.default('[bitvvave.tv API]');
;
//
...
exports.default = {
    ...
    setApiServer: function (newServer) {
        apiPrefix = newServer;
    },
    
    setChatServer: function (newServer) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, httpClient_1.default.get(apiPrefix + 'v1/chat/channels')];
                    case 1:
                        data = _a.sent();
