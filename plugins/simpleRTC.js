/*  Simple RTC 2022-12-25
    So this needs built into a nice tool that can be exported and imported

    So one of the main goals of this is to repack all of the rtcmulti library 
    Into a class structure that can be exported/imported so it will work with something like vue/nuxt
    Currently this tries to bind and store it's context into the window and reference components that don't work

*/

console.log("Loaded webrtc lib");
'use strict';
...
/* Notable changes and fixes by MP 2022-12-15
    ...
    Now the fun part is making this into a module or something that can be imported
*/
console.log("Loaded webrtc lib");
...
var RTCMultiConnection = function(roomid, forceOptions) {
    ...
    console.log("Loaded webrtc lib - Instance loaded");
    (function(that) {
        if (!that) {
            return;
        }
...
//export const connection = new RTCMultiConnection();
